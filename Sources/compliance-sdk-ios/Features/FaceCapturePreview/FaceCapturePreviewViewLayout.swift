//
//  FaceCapturePreviewViewLayout.swift
//
//
...
class FaceCapturePreviewViewLayout: UIView {
    ...
    override init(frame: CGRect) {
        ...
        imagePreviewContainer.heightAnchor.constraint(equalToConstant: 386).isActive = true
        ...
        insideFrameCHeck.textabel.text = "Is your face inside the frame?"
